...
const Submissions = () => (
  <Container className="bg-white section p-4 my-5 rounded">
    ...
    <p className="mb-0">
      Research papers and experience reports related to the above topics are solicited. Papers should be submitted in the PDF format using the ACM-SAC proceedings <a href="https://www.sigapp.org/sac/sac2027/authorkit.php">format</a> via the START submission system. <strong>Full papers</strong> are limited to <strong>8 pages</strong> with the option (at an extra charge) to add 2 more pages.</p>
      <Row className="justify-content-center my-3">
        <Button className="btn-lg" href='https://easychair.org/my/conference?conf=sac2027'>Submit a paper</Button>
      </Row>
    <p>
